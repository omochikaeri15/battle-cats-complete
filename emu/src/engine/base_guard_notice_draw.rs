...
use super::{draw_context, draw_model, get_base_pos_x, get_drawable_width, maanim_execute, AppContext};
...
pub fn base_guard_notice_draw(ctx: &mut AppContext) -> Result<(), Fault> {
    ...
    let x = operation::cvttsd2si(width.wrapping_add(-0x3c0) as f64 * 0.5 + operation::div_10(pos) as f64);
