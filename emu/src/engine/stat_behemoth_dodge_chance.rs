...
pub fn stat_behemoth_dodge_chance(ctx: &mut AppContext, team: i32, unit_id: i32, form: i32) -> Result<i32, Fault> {
    ...
    Ok(get_talent_value(ctx, team, unit_id, form, 0x40, 0)?.wrapping_add(base))
}
