...
pub fn ui_node_set_sprite_tinted(sheet: &Rc<Imgcut>, x: i32, y: i32, cut: i32, red: i32, green: i32, blue: i32) -> Result<Box<Sprite>, Fault> {
    ...
    ui_node_set_color(&mut sprite, red, green, blue);
