...
use super::{
    AppContext, BgEquallySpaced, BgParamSpec, bg_param_enabled, bg_param_roll_float,
    bg_param_roll_int,
};
...
pub fn bg_effect_roll_params(
    ...
    if first_spawn != 0 || bg_param_enabled(&def.destroy_bottom) != 0 {
        ...
        rolls.destroy_bottom =
            bg_param_roll_float(ctx, &spec, &mut rolls.groups, rolls.model, 0.0)?;
    }
