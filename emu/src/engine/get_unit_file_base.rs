...
use super::{query_localizable, string_format_int, string_format_rank_comment, AppContext, UnitBuy, UNIT_BUY};
...
pub fn get_unit_file_base(ctx: &mut AppContext, unit_id: i32, form: i32) -> Result<Vec<u8>, Fault> {
    ...
    if unit_id as u32 <= 0x36b && form as u32 <= 1 {
        ...
        let art = operation::xor_row_decode(&pair, 1, 0).ok_or(Fault::IndexOutOfRange { site: "get_unit_file_base", index: 0, limit: 1 })? as i32;
