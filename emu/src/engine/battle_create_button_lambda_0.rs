...
use super::{
    button_bank_find, mission_tracker_refresh, new_button_set_pressable, new_button_set_touchable, play_sound, battle_check_login_bonus, sound_manager,
    AppContext,
};

const SITE: &str = "battle_create_button_lambda_0";

pub fn battle_create_button_lambda_0(ctx: &mut AppContext, button: i32, event: i32) -> Result<(), Fault> {
    match event {
        4 => {
