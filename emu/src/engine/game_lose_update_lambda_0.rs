...
use super::{bc_log_defeated, dialog_close, get_text_texture, pick_lose_tip, request_save_data, text_texture_cache, AppContext};

const SITE: &str = "game_lose_update_lambda_0";

pub fn game_lose_update_lambda_0(ctx: &mut AppContext, dialog: u64, event: i32, _button: i32) -> Result<(), Fault> {
    match event {
        5 => {
