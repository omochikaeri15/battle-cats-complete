...
use super::{std_map_int_int_from_list_2, std_map_int_int_insert_range, AppContext};
...
pub fn get_equipped_orbs(ctx: &AppContext, unit_id: i32) -> Result<BTreeMap<i32, i32>, Fault> {
    ...
    let slots = ctx.equipped_orbs.get(&unit_id).ok_or(Fault::KeyNotFound { site: "get_equipped_orbs", key: unit_id as i64 })?;
