...
pub fn set_map_open(ctx: &mut AppContext, map_type: i32, map_idx: i32, star: i32, value: i32) -> Result<(), Fault> {
    if map_type as u32 <= 4 {
        let cell = (map_type as u32 as i64) * 0x7d0 + (map_idx as i64) * 4 + star as i64 + AppContext::MAP_OPEN_STORY as i64;
    ...
    match case {
        ...
        0x14 => ctx.set_i32_at(((map_idx as i64) * 0x10 + (star as i64) * 4 + AppContext::MAP_OPEN_NEG6 as i64) as usize, value),
        _ => Ok(()),
    }
}
