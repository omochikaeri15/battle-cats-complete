...
use super::{
    ...
    Mamodel, MapData, MapOption, MapRecord, MatatabiRow, MetaHost, OrbStore, Platform, RankingRecord, ReleasePoint,
...
pub struct AppContext {
    ...
    pub gatya_item_names: Vec<Vec<u8>>,
    pub gatya_item_texts: Vec<[Vec<u8>; 3]>,
    ...
    pub unit_explanations: Vec<[Vec<u8>; 5]>,
    ...
    pub reward_stage_counts: Vec<i32>,
    ...
    pub enemy_book_question: [Vec<u8>; 5],
...
impl AppContext {
    ...
    pub fn new() -> Self {
        Self {
            ...
            gatya_item_names: Default::default(),
            gatya_item_texts: Default::default(),
            ...
            unit_explanations: Default::default(),
            ...
            reward_stage_counts: Default::default(),
            lose_rows: Vec::new(),
