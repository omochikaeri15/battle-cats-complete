...
pub struct AppContext {
    ...
    pub stage_name_counts: [i32; 17],
    pub stage_difficulty: BTreeMap<i32, Vec<f32>>,
    pub treasure1_texts: [Vec<Vec<u8>>; 10],
    pub treasure2_texts: Vec<Vec<u8>>,
    pub treasure3_texts: Vec<[Vec<u8>; 3]>,
    pub treasure3_after_texts: Vec<[Vec<u8>; 3]>,
    pub castle_recipe_unlocks: BTreeMap<i32, Vec<i32>>,
    pub castle_mix_recipes: BTreeMap<i32, [i32; 4]>,
