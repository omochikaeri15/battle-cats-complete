...
use super::{query_localizable, string_format_int, string_format_int2, string_format_int_text_int, texture_cache_load, AppContext, Imgcut, UnitBuy, UNIT_BUY};

pub fn load_unit_icon(ctx: &mut AppContext, unit_id: i32, form: i32, variant: i32) -> Result<Option<Rc<Imgcut>>, Fault> {
    if unit_id as u32 <= 0x36b && form as u32 <= 1 {
        ...
        let art = operation::xor_row_decode(&pair, 1, 0).ok_or(Fault::IndexOutOfRange { site: "load_unit_icon", index: 0, limit: 1 })? as i32;
