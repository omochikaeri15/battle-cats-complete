...
pub fn dialog_show_alt(ctx: &mut AppContext, text: &[u8], first_button: i32, second_button: i32, flags: i32, on_event: Option<DialogEventHandler>) -> Result<u64, Fault> {
    let dialog = dialog_new(ctx, 0, text, first_button, second_button, flags, on_event)?;
