...
fn ok_bounce(ctx: &AppContext) -> Result<i32, Fault> {
...
fn draw_banner(ctx: &mut AppContext) -> Result<(), Fault> {
...
fn draw_ranking(ctx: &mut AppContext, hidden: u8) -> Result<(), Fault> {
