...
use super::{dialog_new, AppContext, DialogEventHandler};

pub fn dialog_show_kind2(ctx: &mut AppContext, text: &[u8], first_button: i32, second_button: i32, flags: i32, on_event: Option<DialogEventHandler>) -> Result<u64, Fault> {
    let dialog = dialog_new(ctx, 2, text, first_button, second_button, flags, on_event)?;
