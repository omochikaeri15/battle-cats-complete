...
pub fn draw_cat_god_menu(ctx: &mut AppContext) -> Result<(), Fault> {
    ...
    if ctx.i32_at(AppContext::CAT_GOD_STATE)? >= 2 {
        ...
        if ctx.i32_at(AppContext::CAT_GOD_STATE)? < 4 {
            ...
            for slot in 0..4usize {
                ...
                let x = operation::div_2(get_drawable_width(ctx)?.wrapping_add(-0x3c0)).wrapping_add(step);
        ...
        if ctx.i32_at(AppContext::CAT_GOD_STATE)? >= 3 {
            ...
            if ctx.i32_at(AppContext::CAT_GOD_STATE)? <= 4 {
                ...
                if ctx.i32_at(AppContext::CAT_GOD_STATE)? == 4 {
                    ...
                    let x = operation::div_2(get_drawable_width(ctx)?.wrapping_add(-0x3c0)).wrapping_add(0x328).wrapping_sub(half);
                    ...
                    let x = operation::div_2(get_drawable_width(ctx)?.wrapping_add(-0x3c0)).wrapping_add(0x1e5).wrapping_sub(half);
    ...
    let half = operation::div_2(get_drawable_width(ctx)?.wrapping_add(-0x3c0));
