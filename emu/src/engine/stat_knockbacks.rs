...
pub fn stat_knockbacks(ctx: &mut AppContext, team: i32, unit_id: i32, form: i32) -> Result<i32, Fault> {
    ...
    Ok(get_talent_value(ctx, team, unit_id, form, 0x1c, 0)?.wrapping_add(base))
}
