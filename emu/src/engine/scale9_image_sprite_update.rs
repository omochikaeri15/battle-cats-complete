use super::{
    Sprite, SpriteKind, image_sprite_update, matrix_rotate, matrix_set_translation_f,
    matrix_translate_f, transform_point_f,
};

pub fn scale9_image_sprite_update(sprite: &mut Sprite, parent: Option<([f32; 6], [f32; 2])>) {
