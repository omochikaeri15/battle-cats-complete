...
use super::{
    add_attacks_remaining, add_barrier_fx_frame, add_burrow_count, add_death_timer, add_deck_cooldown, add_hp, add_money, add_shield_fx_frame,
    add_shockwave_counter, add_stage_record, advance_animation_frame, advance_point_decay, app_on_draw, attack_dmg_dispatch, back_pressed,
    background_particles, barrier_fx_tick, base_guard_notice_tick, base_resists_one_shot, base_shake_start, base_shake_tick, battle_create_button,
    battle_init_win, battle_not_finishing, bgm_player_switch, bgm_player_tick, call_rng, camera_vertical_correction, cannon_attack, cannon_fire,
    cannon_unlocked, cat_cpu_tick, cat_god_menu_input, cat_hit_executor, cat_update, check_collision, clear_barrier_fx_slot, clear_shield_fx_slot,
    clear_zkill_fx_slot, combo_banner_skip_all, combo_banner_update, counter_surge_update, crit_fx_tick, debris_tick, deck_row_swap_tick,
    demon_battle_banner_tick, deploy_limit_reached, deploy_unit, dialog_set_on_draw, dialog_show, dialog_top, does_target, drain_fx_tick,
    effect_sprite_init, enemy_hit_executor, enemy_schedule_tick, enemy_update, entry_find_by_id, explosion_update, fade_update, fever_fade_tick,
    fever_tick, find_item_index, game_lose_update, game_update_lambda_0, game_update_lambda_1, game_update_lambda_2, game_update_lambda_3,
    game_update_lambda_4, game_update_lambda_5, game_update_lambda_6, game_win_update, get_anim_len, get_area_attack, get_attack_cooldown,
    get_attack_count, get_attack_foreswing, get_attack_interval, get_attack_only, get_attacks_remaining, get_auto_camera_mode, get_barrier_fx_active,
    get_barrier_fx_frame, get_barrier_hp, get_barrier_state, get_battle_status, get_boss_type, get_boss_wave_immune, get_bottom_inset_logical,
    get_burrow_count, get_button_unit_form, get_button_unit_id, get_button_unit_row, get_cannon_blast_hit, get_castle_enemy_row, get_cat_name,
    get_crit_fx, get_death_timer, get_deck_cooldown, get_deck_cooldown_max, get_drain_pct, get_drawable_width, get_entity_base_idx,
    get_entity_button, get_entity_frame, get_entity_state, get_frame_damage, get_freeze_timer, get_global_map_id, get_hp, get_item_description,
    get_item_name, get_item_selected, get_kb_proc_hit, get_knockbacks, get_map_type, get_max_hp, get_max_zoom, get_metal_killer_fx, get_money,
    get_money_increment, get_pos_x, get_powerup, get_powerup_available, get_prev_curse_timer, get_prev_freeze_timer, get_prev_slow_timer,
    get_prev_weaken_timer, get_savage_blow_fx, get_score_hit_mask, get_score_time_limit, get_setting, get_shield_fx, get_shield_fx_frame,
    get_shield_hp, get_shield_max, get_shield_state, get_shockwave_counter, get_slot_unit_id, get_special_rule, get_special_rule_params, get_speed,
    get_stage_index, get_stage_record, get_stage_score, get_tech_level, get_text_texture, get_took_damage, get_total_damage_taken, get_toxic_fx,
    get_trait_dojo, get_unit_recharge, get_warp_timer, get_worker_level, get_worker_upgrade_cost, get_zkill_hit, handle_battle_swipe_pinch,
    has_castle_enemy, has_point_decay, hit_test_rect, is_boss, is_score_stage, is_scored_stage, is_touchable_thunk, is_zombie, latch_battle_event,
    load_conjure_desc_textures, log_analytics_event, maanim_get_max_keyframe, max_i32, message_layer_clear, message_layer_set, metal_killer_fx_tick,
    mission_progress, no_more_attacks, on_battle_lost, option_menu_open, option_window_update, orb_deploy_condition, pinch_update, play_sound,
    play_sound_in_battle, point_decay_full, point_lose_update, powerup_available, proc_update, query_localizable, record_stage_lineup,
    record_stage_played, recount_deploy_rarities, savage_fx_tick, scored_map_pays_money, set_attack_cooldown, set_auto_camera_mode,
    set_barrier_fx_active, set_barrier_fx_frame, set_barrier_hp, set_barrier_state, set_battle_status, set_bgm_duck, set_burrow_start_x, set_crit_fx,
    set_curse_timer, set_deck_cooldown, set_deck_cooldown_max, set_drain_pct, set_entity_frame, set_entity_state, set_frame_damage, set_freeze_timer,
    set_hit_flash_timer, set_hp, set_max_hp, set_metal_killer_fx, set_no_revive, set_powerup, set_savage_blow_fx, set_score_hit_mask, set_shield_fx,
    set_shield_fx_frame, set_shield_hp, set_shield_state, set_shockwave_counter, set_slow_timer, set_stage_record, set_toxic_fx, set_warp_timer,
    set_weaken_timer, set_zkill_hit, shield_fx_tick, slot_desc_wait_elapsed, slot_has_flagged_orb, slot_occupied, sniper_update, sound_manager,
    spawn_entity, stage_entry_base_trigger, stage_entry_count, stage_entry_is_boss, std_map_int_int_subscript, std_map_int_map_int_subscript,
    std_shared_ptr_texture_assign, std_shared_ptr_texture_reset, std_string_from_cstr, surge_update, text_texture_cache, touch_began, touch_is_down,
    touch_released, toxic_fx_tick, trial_win_update, turn_on_proc_badge, unit_info_select, update_keep_awake, upgrade_worker, validate_map_type,
    vibration_reset, vibration_tick, wave_apply_hits, wave_update, worker_unlocked, zkill_fx_tick, AppContext, BUTTON_PRESS_BOUNCE, Base, CatStats,
    Debris, EffectSprite, EnemyStats, Entity, FxSlot,
};
...
pub fn main_battle_loop(ctx: &mut AppContext) -> Result<bool, Fault> {
    ...
    'frame: {
        if ctx.u8_at(AppContext::UNIT_INFO_OVERLAY_OPEN)? != 0 {
            ...
            loop {
                ...
                if slot <= 4 {
                    shift = get_setting(&ctx.settings, b"battle_slot_2lines_line", 0x5a)?.wrapping_neg();
                }
                ...
                'button: {
                    ...
                    let column = *ctx.deck_button_x.get(slot).ok_or(Fault::IndexOutOfRange { site: SITE, index: slot as i64, limit: 10 })? as f64;
                    let x = operation::cvttsd2si(get_drawable_width(ctx)?.wrapping_add(-0x3c0) as f64 * 0.5 + column);
        ...
        'menus: {
            ...
            if ctx.u8_at(AppContext::CAT_GOD_MENU_IS_OPEN)? == 0 {
                ...
                ctx.set_i32_at(AppContext::BATTLE_INTRO_FRAME, if intro < 0x149 { intro.wrapping_add(1) } else { 0x14a })?;

                let offset_x = (get_drawable_width(ctx)?.wrapping_add(-0x3c0) as f64 * 0.5) as f32;

                ctx.set_f32_at(AppContext::CAMERA_OFFSET, offset_x)?;
                ctx.set_f32_at(AppContext::CAMERA_OFFSET.wrapping_add(4), ctx.i32_at(AppContext::BATTLE_ZOOM_Y)? as f32)?;
                ...
                ctx.set_f32_at(AppContext::CAMERA_OFFSET.wrapping_add(4), pan_x * m1 + m3 * pan_y + e1)?;
                ...
                ctx.set_i32_at(AppContext::SCRATCH_1, zoom_percent)?;
                ...
                'camera: {
                    ...
                    if get_auto_camera_mode(ctx)? == 1 {
                        ...
                        let distance = operation::cvttss2si((stage * scale + -9600.0) / scale).wrapping_sub(ctx.i32_at(AppContext::CAMERA_X)?);
                        ...
                        if get_battle_status(ctx)? == 0 {
                            if distance <= 0x51 {
                                ...
                                let x = ctx.i32_at(AppContext::CAMERA_X)?.wrapping_add(((distance as u32) >> 1) as i32);
                        ...
                        let x = operation::div_2(distance).wrapping_add(ctx.i32_at(AppContext::CAMERA_X)?);

                        ctx.set_i32_at(AppContext::CAMERA_X, x)?;

                        let stage_length = ctx.i32_at(AppContext::STAGE_LENGTH)?;
                        let limit = operation::cvttss2si((stage_length as f32 * scale + -9600.0) / scale);
                    ...
                    if get_battle_status(ctx)? == 0 {
                        if x > 0x51 {
                            ctx.set_i32_at(AppContext::CAMERA_X, ctx.i32_at(AppContext::CAMERA_X)?.wrapping_sub(((x as u32) >> 1) as i32))?;
                    ...
                    ctx.set_i32_at(AppContext::CAMERA_X, ctx.i32_at(AppContext::CAMERA_X)?.wrapping_sub(operation::div_2(x)))?;
                }
                ...
                if get_battle_status(ctx)? == 1 {
                    ...
                    ctx.set_i32_at(AppContext::SETUP_FRAMES, ctx.i32_at(AppContext::SETUP_FRAMES)?.wrapping_add(1))?;
                    ...
                    'input: {
                        'tutorial: {
                            if ctx.i32_at(AppContext::TUTORIAL_CLEARED)? != 0 {
                                    ...
                                    && ctx.i32_at(AppContext::TUTORIAL_STEP)? == 0
                                {
                                    ...
                                    let dialog = dialog_show(ctx, &text, 0, 0, 4, Some(game_update_lambda_3))?;

                                    dialog_set_on_draw(ctx, dialog, Some(game_update_lambda_4));
                                    ctx.set_i32_at(AppContext::TUTORIAL_STEP, ctx.i32_at(AppContext::TUTORIAL_STEP)?.wrapping_add(1))?;
                                ...
                                if get_global_map_id(ctx, 0)? == 0xbb8 && get_stage_index(ctx)? == 2 && get_stage_record(ctx, -2, 0, 2, 0, 0)? == 0 {
                                    let frames = ctx.i32_at(AppContext::BATTLE_FRAME_COUNTER)?;
                                    let key = std_string_from_cstr(b"tutorial_duration1");
                                    let due = frames >= get_setting(&ctx.settings, &key, 0x1e)? && ctx.i32_at(AppContext::TUTORIAL_STEP)? == 0;

                                    if due {
                                        let key = std_string_from_cstr(b"battle_tutorial_3");
                                        let text = query_localizable(ctx, &key);
                                        let dialog = dialog_show(ctx, &text, 0, 0, 4, Some(game_update_lambda_5))?;
                                ...
                                for (seen, two_rows) in [(AppContext::TUTORIAL_DECK_SEEN, false), (AppContext::TUTORIAL_TWO_ROWS_SEEN, true)] {
                                    ...
                                    for button in 0..10 {
                                        filled = filled.wrapping_add((get_button_unit_row(ctx, 0, button)? != -1) as u32);

                                        if filled < 6 {
                                            continue;
                                        }

                                        let touched = touch_is_down(ctx)? != 0 || touch_began(ctx)? != 0 || touch_released(ctx)? != 0;
                            ...
                            if frames >= get_setting(&ctx.settings, &key, 0x96)? && ctx.i32_at(AppContext::TUTORIAL_STEP)? == 0 {
                            ...
                            if frames >= get_setting(&ctx.settings, &key, 0x1c2)? && dialog_top(ctx).is_none() && ctx.i32_at(AppContext::TUTORIAL_STEP)? == 1 {
                                let key = std_string_from_cstr(b"battle_tutorial_1");
                                let text = query_localizable(ctx, &key);
                                let dialog = dialog_show(ctx, &text, 0, 0, 0x24, Some(game_update_lambda_1))?;
                        ...
                        let special_mode = ctx.i32_at(AppContext::ENTRY_STAGE)? == 0x30 || ctx.i32_at(AppContext::CHAPTER_MODE)? == 3 || ctx.i32_at(AppContext::CHAPTER_MODE)? == 0x63;
                        ...
                        if press > 0 {
                            ctx.set_i32_at(AppContext::CAT_GOD_BUTTON_PRESS, press.wrapping_add(1))?;
                            ...
                            if ctx.i32_at(AppContext::ENTRY_STAGE)? == 0x30 || ctx.i32_at(AppContext::CHAPTER_MODE)? == 3 || ctx.i32_at(AppContext::CHAPTER_MODE)? == 0x63 {
                                break 'input;
                            }
                            ...
                            if (ctx.i32_at(AppContext::CAT_GOD_INTRO_STEP)?.wrapping_sub(1) as u32) <= 1 {
                        ...
                        if press > 0 {
                            ...
                            if get_powerup_available(ctx)? != 0 && get_powerup(ctx, 0)? && ctx.u8_at(AppContext::SPEED_UP_LATCH)? == 0 {
                        ...
                        if pressing {
                            ...
                            while button < buttons && ctx.i32_at(AppContext::DECK_PRESS.wrapping_add(button * 4))? <= 0 {
                                button += 1;
                            }
                        ...
                        let half = operation::div_2(ctx.i32_at(AppContext::STAGE_LENGTH)?).wrapping_sub(ctx.i32_at(AppContext::CAMERA_X)?);
                        let column = operation::div_10(half).wrapping_add(-0x41) as f64;
                        let x = ((get_drawable_width(ctx)?.wrapping_add(-0x3c0)) as f64 * 0.5 + column) as f32;
                        let press = ctx.i32_at(AppContext::CAT_GOD_BUTTON_PRESS)?;
                        let bounce = operation::div_2(*BUTTON_PRESS_BOUNCE.get(press as i64 as usize).ok_or(Fault::IndexOutOfRange { site: SITE, index: press as i64, limit: 10 })?);
                        let lift = ctx
                        ...
                        ctx.set_i32_at(AppContext::CAT_GOD_BUTTON_RECT, operation::cvttss2si(near[0]))?;
                        ctx.set_i32_at(AppContext::CAT_GOD_BUTTON_RECT.wrapping_add(4), operation::cvttss2si(near[1]))?;
                        ctx.set_i32_at(AppContext::CAT_GOD_BUTTON_RECT.wrapping_add(8), operation::cvttss2si(far[0] - near[0]))?;
                        ctx.set_i32_at(AppContext::CAT_GOD_BUTTON_RECT.wrapping_add(0xc), operation::cvttss2si(far[1] - near[1]))?;

                        if touch_is_down(ctx)? != 0 {
                            if ctx.u8_at(AppContext::DECK_ROW_SWAPPING)? != 0 || ctx.u8_at(AppContext::CAMERA_DRAGGING)? != 0 {
                        ...
                        if ctx.i32_at(AppContext::SWIPE_VELOCITY)? == 0 && ctx.u8_at(AppContext::PINCH_ZOOMED)? == 0 {
                            for item in 0..6i32 {
                                if touch_is_down(ctx)? == 0 {
                                    continue;
                                }

                                let rect = AppContext::ITEM_RECTS.wrapping_add(item as usize * 0x10);
                                let (rx, ry, rw, rh) = (ctx.i32_at(rect)?, ctx.i32_at(rect.wrapping_add(4))?, ctx.i32_at(rect.wrapping_add(8))?, ctx.i32_at(rect.wrapping_add(0xc))?);
                                ...
                                if !(ctx.i32_at(AppContext::TOOLTIP_ITEM)? as u32 as i32 == item && ctx.u8_at(AppContext::INPUT_BLOCKED)? != 0) {
                                    ...
                                    let slot = ctx.tooltip_texts.get_mut(page as usize).ok_or(Fault::IndexOutOfRange { site: SITE, index: page, limit: 8 })?;
                                    ...
                                    loop {
                                        ...
                                        let slot = ctx.tooltip_texts.get_mut(target).ok_or(Fault::IndexOutOfRange { site: SITE, index: target as i64, limit: 8 })?;
                                    ...
                                    if ctx.i32_at(AppContext::TOOLTIP_ITEM)? == 0 && ctx.u8_at(AppContext::SPEED_UP_LATCH)? == 0 {
                        ...
                        if ctx.u8_at(AppContext::CPU_ENABLED)? == 0 {
                            ...
                            if cannon_unlocked(ctx)? && touch_is_down(ctx)? != 0 && hit_test_rect(ctx, rx, ry, rw, rh)? {
                            ...
                            if worker_unlocked(ctx)? && touch_is_down(ctx)? != 0 && hit_test_rect(ctx, rx, ry, rw, rh)? {
                        ...
                        if cannon_unlocked(ctx)? && touch_released(ctx)? != 0 && hit_test_rect(ctx, rx, ry, rw, rh)? && ctx.u8_at(AppContext::INPUT_BLOCKED)? == 0 {
                            cannon_fire(ctx, 1)?;
                        ...
                        if worker_unlocked(ctx)? && touch_released(ctx)? != 0 && hit_test_rect(ctx, rx, ry, rw, rh)? && ctx.u8_at(AppContext::INPUT_BLOCKED)? == 0 {
                            ...
                            if get_worker_level(ctx, wallet)? != 7 && get_money(ctx, wallet)? >= get_worker_upgrade_cost(ctx, wallet)? {
                        ...
                        let pause_tapped = (touch_released(ctx)? != 0 && hit_test_rect(ctx, px, py, pw, ph)?) || back_pressed(ctx)? != 0;

                        if pause_tapped && ctx.u8_at(AppContext::INPUT_BLOCKED)? == 0 {
                            play_sound(sound_manager(ctx)?, 0xb, None);
                            ctx.set_i32_at(AppContext::UI_TAP_LOCKOUT, 0)?;
                            ctx.set_block_at::<1>(AppContext::INPUT_BLOCKED, [0])?;
                            ctx.set_i32_at(AppContext::PAUSE_PRESS, ctx.i32_at(AppContext::PAUSE_PRESS)?.wrapping_add(1))?;
                        ...
                        for (item, counter) in [(0usize, AppContext::SPEED_UP_PRESS), (3usize, AppContext::CPU_PRESS), (5usize, AppContext::SNIPER_PRESS)] {
                            ...
                            let usable = if item == 0 { powerup_available(ctx, 0)? } else { get_item_selected(ctx, item as i32)? };
                        ...
                        if cat_god_tapped {
                            if ctx.i32_at(AppContext::CAT_GOD_AVAILABLE)? > 0 {
                                ...
                                ctx.set_block_at::<1>(AppContext::INPUT_BLOCKED, [0])?;
                                play_sound(sound_manager(ctx)?, 0xb, None);
                                ctx.set_i32_at(AppContext::CAT_GOD_BUTTON_PRESS, ctx.i32_at(AppContext::CAT_GOD_BUTTON_PRESS)?.wrapping_add(1))?;
                                skip_banner = true;
                            }
                        ...
                        match ctx.i32_at(AppContext::DECK_ROW_SHOWN)? {
                            0 => ctx.set_i32_at(AppContext::SCRATCH_0, 0)?,
                            1 => ctx.set_i32_at(AppContext::SCRATCH_0, 5)?,
                            _ => {}
                        }
                        ...
                        loop {
                            ...
                            let first = if ctx.u8_at(AppContext::DECK_TWO_LINES)? != 0 { 0 } else { ctx.i32_at(AppContext::SCRATCH_0)? };
                            let index = (first as i64).wrapping_add(button as i64) as i32;

                            'press: {
                                if touch_is_down(ctx)? != 0 {
                                    let column = *ctx.deck_button_x.get(index as i64 as usize).ok_or(Fault::IndexOutOfRange { site: SITE, index: index as i64, limit: 10 })? as f64;
                                    let x = operation::cvttsd2si(get_drawable_width(ctx)?.wrapping_add(-0x3c0) as f64 * 0.5 + column);
                                    let y = ctx.i32_at(AppContext::LETTERBOX_SHIFT)?.wrapping_add(ctx.deck_bar_base_y.wrapping_add(shift)).wrapping_sub(1);

                                    if hit_test_rect(ctx, x, y, 0x6e, 0x58)? {
                                        let pressed = AppContext::DECK_BUTTON_PRESSED.wrapping_add(button);
                                        ...
                                        if ctx.u8_at(pressed)? == 0 {
                                            ...
                                            std_shared_ptr_texture_assign(&mut ctx.unit_info_texts[0], Some(texture));
                                            std_shared_ptr_texture_reset(&mut ctx.unit_info_texts[1]);
                                            std_shared_ptr_texture_reset(&mut ctx.unit_info_texts[2]);
                                            std_shared_ptr_texture_reset(&mut ctx.unit_info_texts[3]);
                                            load_conjure_desc_textures(ctx, 1, unit_id, 0)?;
                                        } else if index == ctx.i32_at(AppContext::DECK_HOLD_SLOT)? {
                                            ctx.set_i32_at(AppContext::DECK_HOLD_FRAMES, ctx.i32_at(AppContext::DECK_HOLD_FRAMES)?.wrapping_add(1))?;

                                            if slot_desc_wait_elapsed(ctx)? {
                                                ctx.set_block_at::<1>(AppContext::DECK_BUTTON_HELD, [1])?;
                                ...
                                ctx.set_block_at::<1>(AppContext::DECK_BUTTON_PRESSED.wrapping_add(button), [0])?;
                            }

                            if touch_released(ctx)? != 0 {
                                let column = *ctx.deck_button_x.get(index as i64 as usize).ok_or(Fault::IndexOutOfRange { site: SITE, index: index as i64, limit: 10 })? as f64;
                                let x = operation::cvttsd2si(get_drawable_width(ctx)?.wrapping_add(-0x3c0) as f64 * 0.5 + column);
                                let y = ctx.i32_at(AppContext::LETTERBOX_SHIFT)?.wrapping_add(shift.wrapping_add(ctx.deck_bar_base_y)).wrapping_sub(1);

                                if hit_test_rect(ctx, x, y, 0x6e, 0x58)? && ctx.u8_at(AppContext::INPUT_BLOCKED)? == 0 && !slot_desc_wait_elapsed(ctx)? {
                                    ctx.set_i32_at(AppContext::UI_TAP_LOCKOUT, 0)?;
                                    ctx.set_block_at::<1>(AppContext::INPUT_BLOCKED, [0])?;
                ...
                if ctx.i32_at(AppContext::BABY_BOOM_ACTIVE)? == 1 {
                    ctx.set_i32_at(AppContext::BABY_BOOM_FRAMES, ctx.i32_at(AppContext::BABY_BOOM_FRAMES)?.wrapping_add(1))?;
                ...
                let capped = match cap {
                    Some(values) => {
                        let first = *values.first().ok_or(Fault::IndexOutOfRange { site: SITE, index: 0, limit: 0 })?;
                ...
                if flash >= 0 {
                    ctx.set_i32_at(AppContext::DEPLOY_FULL_FLASH, if (flash as u32) < 0x32 { flash.wrapping_add(1) } else { -1 })?;
                }
                ...
                for faction in 0..2i32 {
                    ...
                    for button in 0..10usize {
                        if ctx.i32_at(wallet.wrapping_add(AppContext::WALLET_CONJURE_READY).wrapping_add(button * 4))? == 1
                            && ctx.i32_at(wallet.wrapping_add(AppContext::WALLET_CONJURE_LOCKOUT).wrapping_add(button * 4))? == 0
                        {
                            let timer = wallet.wrapping_add(AppContext::WALLET_CONJURE_TIMER).wrapping_add(button * 4);
                ...
                while step < ctx.i32_at(AppContext::SPEED)? {
                    'substep: {
                        ...
                        if queued > 0 {
                            ...
                            while index >= 1 {
                                let entry = *ctx.deploy_queue.get(index - 1).ok_or(Fault::IndexOutOfRange { site: SITE, index: index as i64 - 1, limit: queued as i64 })?;
                                let button = entry as u32 as i32;
                                let delay = (entry >> 32) as u32 as i32;

                                if delay > 0 {
                                    if let Some(record) = ctx.deploy_queue.get_mut(index - 1) {
                                        *record = (entry & 0xffff_ffff) | (((delay.wrapping_sub(1)) as u32 as u64) << 32);
                                    }
                                } else {
                                    let unit_id = get_button_unit_id(ctx, 0, button)?;
                                    let level = get_tech_level(ctx, AppContext::UNIT_LEVELS.wrapping_add((unit_id as i64 as usize).wrapping_mul(8)))?;
                                    let counter = AppContext::faction_flags(0).wrapping_add(AppContext::WALLET_DEPLOY_COUNTS).wrapping_add((button as i64 as usize).wrapping_mul(4));
                                    ...
                                    let z_min = ctx.i32_at(AppContext::cat_stat(z_row.wrapping_sub(2), z_form, CatStats::MINIMUM_Z_LAYER))?;
                                    let z_row = get_button_unit_row(ctx, 0, button)?;
                                    let z_form = get_button_unit_form(ctx, 0, button)?;
                                    let z_max = ctx.i32_at(AppContext::cat_stat(z_row.wrapping_sub(2), z_form, CatStats::MAXIMUM_Z_LAYER))?;
                        ...
                        'finish: {
                            if get_battle_status(ctx)? == 0 && is_scored_stage(ctx)? {
                                ...
                                if elapsed != 0x7fffffff {
                                    ...
                                    play_sound(sound_manager(ctx)?, if pays { 0xbd } else { 0x39 }, None);
                                    vibration_reset(ctx)?;
                                    ...
                                    let first_clear = get_stage_record(ctx, map_type, map_index, stage, star, 0)? <= 0;
                                    ...
                                    if get_stage_record(ctx, map_type, map_index, stage, star, 0)? >= 0x2710 {
                                        let map_type = validate_map_type(ctx.i32_at(AppContext::SAVED_MAP_TYPE)?);
                                        let map_index = ctx.i32_at(AppContext::MAP_INDEX)?;
                                        let stage = ctx.i32_at(AppContext::STAGE_ROW)?;
                                        let star = ctx.i32_at(AppContext::STAR_LEVEL)?;

                                        set_stage_record(ctx, map_type, map_index, stage, star, 0x270f, 0)?;
                                    }
                                    ...
                                    if get_map_type(ctx, 0)? == 4 {
                                        let map_index = ctx.i32_at(AppContext::MAP_INDEX)?;
                                        let best = entry_find_by_id(&ctx.ranking_entries, map_index);
                                        ...
                                        let best = *std_map_int_int_subscript(std_map_int_map_int_subscript(&mut ctx.best_scores, &map_index), &stage_row);
                                        let total = ctx.i32_at(AppContext::SCORE_TOTAL)?;

                                        if best < total {
                                            *std_map_int_int_subscript(std_map_int_map_int_subscript(&mut ctx.best_scores, &map_index), &stage_row) = total;
                                            ctx.set_i32_at(AppContext::NEW_BEST_SCORE, 1)?;
                                        }
                                    }
                        ...
                        ctx.set_i32_at(AppContext::BATTLE_FRAME_COUNTER, ctx.i32_at(AppContext::BATTLE_FRAME_COUNTER)?.wrapping_add(1))?;

                        if get_battle_status(ctx)? == 0 {
                            let played = ctx.i32_at(AppContext::PLAY_FRAMES)?;

                            ctx.set_i32_at(AppContext::PLAY_FRAMES, if played >= 0x752f { 0x7530 } else { played.wrapping_add(1) })?;
                        }
                        ...
                        'engage: for faction in 0..2i32 {
                            for slot in 1..0x33i32 {
                                ...
                                if get_entity_state(ctx, faction, slot)? == 1 || get_entity_state(ctx, faction, slot)? == 0 {
                                    ...
                                    if get_entity_state(ctx, faction, slot)? == 0 && get_speed(ctx, faction, slot)? == 0 {
                        ...
                        for slot in 1..0x33i32 {
                            ...
                            if ctx.i32_at(AppContext::entity_field(0, slot, Entity::STATE))? == 1 && ctx.i32_at(AppContext::entity_field(0, slot, Entity::FREEZE_TIMER))? <= 0 {
                                ...
                                if get_attack_only(ctx, 0, slot)? {
                                    ...
                                    if check_collision(ctx, 0, slot, 0, 0)? {
                                        ...
                                        if get_attack_cooldown(ctx, 0, slot)? == 0 && get_attacks_remaining(ctx, 0, slot)? != 0 {
                                            next_state = Some(2);
                                        }
                                    }
                                    ...
                                    if next_state.is_none() {
                                        for target in 1..0x33 {
                                            if !does_target(ctx, 0, slot, target)? && get_entity_base_idx(ctx)? != target {
                                                continue;
                                            }
                                    ...
                                    if next_state.is_none() && !engaged && get_speed(ctx, 0, slot)? > 0 {
                                        next_state = Some(0);
                                    }
                                }
                            ...
                            if check_collision(ctx, 0, slot, 0, attack)? {
                                ...
                                ctx.set_i32_at(AppContext::HIT_LIST.wrapping_add(count.wrapping_mul(8)), 0)?;

                                let distance = ctx.i32_at(AppContext::entity_field(1, 0, Entity::POS_X))?.wrapping_sub(ctx.i32_at(AppContext::entity_field(1, 0, Entity::HITBOX_POS))?);
                                let count = ctx.i32_at(AppContext::HIT_COUNT)? as i64 as usize;

                                ctx.set_i32_at(AppContext::HIT_LIST.wrapping_add(count.wrapping_mul(8)).wrapping_add(4), distance)?;
                                ctx.set_i32_at(AppContext::HIT_COUNT, (count as i32).wrapping_add(1))?;
                            }
                            ...
                            for target in 1..0x33i32 {
                                ...
                                if get_attack_only(ctx, 0, slot)? && !does_target(ctx, 0, slot, target)? && get_entity_base_idx(ctx)? as u32 as i32 != target {
                                    continue;
                                }

                                let count = ctx.i32_at(AppContext::HIT_COUNT)? as i64 as usize;

                                ctx.set_i32_at(AppContext::HIT_LIST.wrapping_add(count.wrapping_mul(8)), target)?;

                                let distance = ctx.i32_at(AppContext::entity_field(1, target, Entity::POS_X))?.wrapping_sub(ctx.i32_at(AppContext::entity_field(1, target, Entity::HITBOX_POS))?);
                                let count = ctx.i32_at(AppContext::HIT_COUNT)? as i64 as usize;
                            ...
                            if get_area_attack(ctx, 0, slot)? {
                                ...
                                while index < ctx.i32_at(AppContext::HIT_COUNT)? as i64 {
                                    targets.push(ctx.i32_at(AppContext::HIT_LIST.wrapping_add((index as usize).wrapping_mul(8)))?);
                                    index += 1;
                                }
                            ...
                            if count >= 2 {
                                ...
                                while first < ctx.i32_at(AppContext::HIT_COUNT)? as i64 - 1 {
                                    let entry = AppContext::HIT_LIST.wrapping_add((first as usize).wrapping_mul(8));
                                    let mut best = first;
                                    ...
                                    while other < ctx.i32_at(AppContext::HIT_COUNT)? as i64 {
                                        let distance = ctx.i32_at(AppContext::HIT_LIST.wrapping_add((other as usize).wrapping_mul(8)).wrapping_add(4))?;
                                    ...
                                    let winner = AppContext::HIT_LIST.wrapping_add((best as i32 as i64 as usize).wrapping_mul(8));

                                    ctx.set_i32_at(AppContext::HIT_SWAP, ctx.i32_at(entry)?)?;
                                    ctx.set_i32_at(AppContext::HIT_SWAP.wrapping_add(4), ctx.i32_at(entry.wrapping_add(4))?)?;
                                    ctx.set_block_at::<8>(entry, ctx.block_at::<8>(winner)?)?;
                                    ctx.set_block_at::<8>(winner, ctx.block_at::<8>(AppContext::HIT_SWAP)?)?;
                                    first += 1;
                                }
                            }
                            ...
                            if count > 0 {
                                ...
                                while ties < count && ctx.i32_at(AppContext::HIT_LIST.wrapping_add((ties as usize).wrapping_mul(8)).wrapping_add(4))? == lead {
                                    ties += 1;
                                }
                            }

                            let pick = call_rng(ctx, ties);
                            let target = ctx.i32_at(AppContext::HIT_LIST.wrapping_add((pick as i64 as usize).wrapping_mul(8)))?;
                        ...
                        for slot in 1..0x33i32 {
                            ...
                            if get_entity_state(ctx, 1, slot)? == 1 && get_freeze_timer(ctx, 1, slot)? <= 0 {
                                ...
                                if check_collision(ctx, 1, slot, 0, 0)? {
                                    ...
                                    if get_attack_cooldown(ctx, 1, slot)? == 0 && get_attacks_remaining(ctx, 1, slot)? != 0 {
                                        next_state = Some(2);
                                    }
                                }
                                ...
                                if next_state.is_none() {
                                    for target in 1..0x33 {
                                        ...
                                        if is_zombie(ctx, 1, slot)? && get_burrow_count(ctx, 1, slot)? != 0 && !(shockwave_live && is_boss(ctx, 1, slot)?) {
                            ...
                            loop {
                                ...
                                'fire: {
                                    ...
                                    for target in 0..0x33i32 {
                                        ...
                                        let distance = ctx.i32_at(AppContext::entity_field(0, target, Entity::HITBOX_POS))?.wrapping_add(ctx.i32_at(AppContext::entity_field(0, target, Entity::POS_X))?);
                                        let count = ctx.i32_at(AppContext::HIT_COUNT)? as i64 as usize;
                        ...
                        let mut shield_hits: [BTreeMap<i32, u8>; 2] = [BTreeMap::new(), BTreeMap::new()];
                        let base_slot = if has_castle_enemy(ctx)? { get_entity_base_idx(ctx)? as u32 as i64 } else { 0 };

                        for faction in 0..2i32 {
                            for slot in 0..0x33i32 {
                                if get_barrier_fx_active(ctx, faction, slot)? {
                                    add_barrier_fx_frame(ctx, faction, slot, 1)?;

                                    let frame = get_barrier_fx_frame(ctx, faction, slot)?;
                                ...
                                if get_shield_fx(ctx, faction, slot)? != 0 {
                                    add_shield_fx_frame(ctx, faction, slot, 1)?;

                                    let frame = get_shield_fx_frame(ctx, faction, slot)?;
                                    let kind = get_shield_fx(ctx, faction, slot)?.wrapping_sub(1);
                                    let anim = ctx.shield_anims.get(kind as i64 as usize).ok_or(Fault::IndexOutOfRange { site: SITE, index: kind as i64, limit: 5 })?;
                                ...
                                if faction == 1 {
                                    if ctx.metal_killer_map.contains_key(&slot) {
                                        let key = std_string_from_cstr(b"battle_metal_killer_hp_type");
                                        let mut remaining = if get_setting(&ctx.settings, &key, 0)? != 0 { get_hp(ctx, 1, slot)? } else { get_max_hp(ctx, 1, slot)? };
                                        let percents = ctx.metal_killer_map.entry(slot).or_default().clone();

                                        for percent in percents {
                                            let damage = max_i32(operation::div_100(percent.wrapping_mul(remaining)), 1);
                                    ...
                                    if slot as i64 == base_slot
                                        ...
                                        && get_hp(ctx, 1, base_slot as i32)? <= get_frame_damage(ctx, 1, base_slot as i32)?
                                    {
                                        let hp = get_hp(ctx, 1, base_slot as i32)?;

                                        set_frame_damage(ctx, 1, base_slot as i32, hp.wrapping_sub(1))?;
                                    }
                                }
                                ...
                                if get_barrier_hp(ctx, faction, slot)? > 0 || get_shield_hp(ctx, faction, slot)? > 0 {
                                    if get_shield_hp(ctx, faction, slot)? > 0 {
                                        shield_hits[faction as usize].insert(slot, 1);

                                        if get_shield_state(ctx, faction, slot)? == 0 {
                                            let left = max_i32(get_shield_hp(ctx, faction, slot)?.wrapping_sub(get_frame_damage(ctx, faction, slot)?), 0);
                                    ...
                                    if (get_barrier_hp(ctx, faction, slot)? > 0 && get_barrier_state(ctx, faction, slot)? == 0)
                                        || get_barrier_state(ctx, faction, slot)? == 1
                                        || (get_shield_hp(ctx, faction, slot)? > 0 && get_shield_state(ctx, faction, slot)? == 0)
                                    ...
                                    if get_barrier_hp(ctx, faction, slot)? > 0 || get_barrier_state(ctx, faction, slot)? == 1 {
                                    ...
                                    if get_barrier_hp(ctx, faction, slot)? > 0 && get_barrier_state(ctx, faction, slot)? == 0 {
                                        if !get_barrier_fx_active(ctx, faction, slot)? {
                                            set_barrier_fx_active(ctx, faction, slot, 1)?;
                                        }

                                        set_barrier_fx_frame(ctx, faction, slot, 0)?;
                                        play_sound_in_battle(ctx, 0x47)?;
                                    } else if get_barrier_state(ctx, faction, slot)? == 1 || get_barrier_state(ctx, faction, slot)? == 2 {
                                        set_barrier_fx_active(ctx, faction, slot, 0)?;
                                        ...
                                        for record in 0..0x1eusize {
                                            if ctx.u8_at(AppContext::BARRIER_FX.wrapping_add(record * AppContext::BARRIER_FX_STRIDE))? == 0 {
                                                free = Some(record);
                                        ...
                                        if let Some(record) = free {
                                            let fx = AppContext::BARRIER_FX.wrapping_add(record * AppContext::BARRIER_FX_STRIDE);

                                            clear_barrier_fx_slot(ctx, fx)?;
                                            ctx.set_block_at::<1>(fx, [1])?;
                                            ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_X), ctx.i32_at(AppContext::entity_field(faction, slot, Entity::POS_X))?)?;
                                            ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_Y), ctx.i32_at(AppContext::entity_field(faction, slot, Entity::POS_Y))?)?;

                                            let broken = get_barrier_state(ctx, faction, slot)? == 2;

                                            ctx.set_block_at::<1>(fx.wrapping_add(FxSlot::BROKEN), [broken as u8])?;
                                        }
                                    }

                                    if get_shield_hp(ctx, faction, slot)? > 0 && get_shield_state(ctx, faction, slot)? == 0 {
                                        if get_shield_fx(ctx, faction, slot)? == 0 {
                                            let low = get_shield_hp(ctx, faction, slot)? < operation::div_2(get_shield_max(ctx, faction, slot)?);

                                            set_shield_fx(ctx, faction, slot, low as i32 + 1)?;
                                        }

                                        set_shield_fx_frame(ctx, faction, slot, 0)?;
                                        play_sound_in_battle(ctx, 0x88)?;
                                    } else if get_shield_state(ctx, faction, slot)? == 1 || get_shield_state(ctx, faction, slot)? == 2 {
                                        set_shield_fx(ctx, faction, slot, 0)?;
                                        ...
                                        for record in 0..0x1eusize {
                                            if ctx.u8_at(AppContext::SHIELD_FX.wrapping_add(record * AppContext::SHIELD_FX_STRIDE))? == 0 {
                                                free = Some(record);
                                        ...
                                        if let Some(record) = free {
                                            let fx = AppContext::SHIELD_FX.wrapping_add(record * AppContext::SHIELD_FX_STRIDE);

                                            clear_shield_fx_slot(ctx, fx)?;
                                            ctx.set_block_at::<1>(fx, [1])?;
                                            ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_X), ctx.i32_at(AppContext::entity_field(faction, slot, Entity::POS_X))?)?;
                                            ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_Y), ctx.i32_at(AppContext::entity_field(faction, slot, Entity::POS_Y))?.wrapping_add(-0x1a4))?;
                                ...
                                if battle_not_finishing(ctx)? {
                                    ...
                                    ctx.set_i32_at(AppContext::SCORE_TOTAL, ctx.i32_at(AppContext::SCORE_TOTAL)?.wrapping_add(mask))?;
                                    set_score_hit_mask(ctx, faction, slot, 0)?;
                                }
                            }
                        }
                        ...
                        while event < ctx.counter_surge_events.len() {
                            if ctx.counter_surge_events[event].state == 0 {
                                let (faction, slot) = (ctx.counter_surge_events[event].faction, ctx.counter_surge_events[event].slot);
                        ...
                        while entry < ctx.stage_enemies.len() {
                            ...
                            'trigger: {
                                if has_castle_enemy(ctx)? && ctx.i32_at(AppContext::enemy_stat(get_castle_enemy_row(ctx)?.wrapping_sub(2), EnemyStats::TRAIT_DOJO))? != 0 {
                                    let base = get_entity_base_idx(ctx)?;

                                    if get_total_damage_taken(ctx, 1, base)? < stage_entry_base_trigger(&row) {
                                        break 'trigger;
                                    }
                                } else {
                                    let hp = get_hp(ctx, 1, 0)?;
                                    let damage = get_frame_damage(ctx, 1, 0)?;
                                    let max = ctx.i32_at(AppContext::entity_field(1, 0, Entity::MAX_HP))?;

                                    if hp.wrapping_sub(damage) > operation::div_100(stage_entry_base_trigger(&row).wrapping_mul(max)) {
                                        break 'trigger;
                                    }
                                }

                                if stage_entry_count(&row) != 0 {
                                    let spawned = ctx.spawn_states.get(entry).map(|state| state[1]).ok_or(Fault::IndexOutOfRange { site: SITE, index: entry as i64, limit: ctx.spawn_states.len() as i64 })?;
                                ...
                                if stage_entry_is_boss(&row) && ctx.i32_at(AppContext::entity_field(1, 0, Entity::HP))? >= 2 {
                        ...
                        for faction in 0..2i32 {
                            ...
                            let wallet = AppContext::faction_flags(faction);
                            let debris_ring = AppContext::CAT_DEBRIS.wrapping_add((faction as usize).wrapping_mul(0x380));
                            ...
                            for slot in 0..0x33i32 {
                                ...
                                if get_frame_damage(ctx, faction, slot)? != 0 {
                                    let exempt = has_castle_enemy(ctx)?
                                        && !first
                                        && (slot == 0 || get_entity_base_idx(ctx)? as u32 as i32 == slot)
                                        && get_trait_dojo(ctx, 1, get_entity_base_idx(ctx)?)?;

                                    if !exempt {
                                        let is_base = if slot == 0 || first { slot == 0 } else { get_entity_base_idx(ctx)? as u32 as i32 == slot };

                                        latch_battle_event(&mut ctx.battle_event_latch, faction, is_base as i32 | 2);
                                    }
                                }

                                if get_frame_damage(ctx, faction, slot)? == 0 && *shield_hits[faction as usize].entry(slot).or_insert(0) == 0 {
                                    continue;
                                }
                                ...
                                if get_crit_fx(ctx, faction, slot)? || get_savage_blow_fx(ctx, faction, slot)? || get_toxic_fx(ctx, faction, slot)? || get_metal_killer_fx(ctx, faction, slot)? {
                                    if get_crit_fx(ctx, faction, slot)? {
                                        crit_index = 0;

                                        for record in 0..200usize {
                                            let fx = AppContext::CRIT_FX.wrapping_add(record * AppContext::CRIT_FX_STRIDE);

                                            if ctx.u8_at(fx)? == 0 {
                                                ctx.set_block_at::<1>(fx, [1])?;
                                                crit_index = record;
                                                ctx.set_i32_at(fx.wrapping_add(FxSlot::FRAME), 0)?;
                                    ...
                                    if get_savage_blow_fx(ctx, faction, slot)? {
                                        let (x, y) = if slot != 0 {
                                            ...
                                            (x.wrapping_sub(spread.wrapping_mul(10)).wrapping_add(-0x1b5), y.wrapping_add(rise.wrapping_mul(10)).wrapping_add(-0x52d))
                                        } else {
                                            ...
                                            (x.wrapping_add(spread.wrapping_mul(10)).wrapping_add(-0x3a9), y.wrapping_sub(rise.wrapping_mul(10)).wrapping_add(-0x497))
                                        };

                                        let mut sprite = EffectSprite::default();

                                        effect_sprite_init(&mut sprite, x, y);
                                        ctx.savage_fx.push(sprite);
                                    }

                                    if get_toxic_fx(ctx, faction, slot)? {
                                        let (x, y) = if slot != 0 {
                                            let x = ctx.i32_at(entity.wrapping_add(Entity::POS_X))?;
                                            let spread = call_rng(ctx, 0x2e);
                                            let y = ctx.i32_at(entity.wrapping_add(Entity::POS_Y))?;
                                        ...
                                        effect_sprite_init(&mut sprite, x, y);
                                        ctx.toxic_fx.push(sprite);
                                    }

                                    if get_metal_killer_fx(ctx, faction, slot)? {
                                        let (x, y) = if slot != 0 {
                                            let x = ctx.i32_at(entity.wrapping_add(Entity::POS_X))?;
                                            let spread = call_rng(ctx, 0x2e);
                                            let y = ctx.i32_at(entity.wrapping_add(Entity::POS_Y))?;
                                        ...
                                        effect_sprite_init(&mut sprite, x, y);
                                        ctx.metal_killer_fx.push(sprite);
                                    }
                                }

                                let debris = debris_ring.wrapping_add((slot as i64 as usize).wrapping_mul(AppContext::DEBRIS_STRIDE));
                                ...
                                if slot != 0 {
                                    ...
                                    if get_crit_fx(ctx, faction, slot)? {
                                        let fx = AppContext::CRIT_FX.wrapping_add(crit_index * AppContext::CRIT_FX_STRIDE);
                                        let x = ctx.i32_at(entity.wrapping_add(Entity::POS_X))?;
                                        let spread = call_rng(ctx, 0x2e);

                                        ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_X), x.wrapping_sub(spread.wrapping_mul(10)).wrapping_add(-0x1b5))?;

                                        let y = ctx.i32_at(entity.wrapping_add(Entity::POS_Y))?;
                                        let rise = call_rng(ctx, 0x1f);

                                        ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_Y), y.wrapping_add(rise.wrapping_mul(10)).wrapping_add(-0x52d))?;
                                    }

                                    let x = ctx.i32_at(entity.wrapping_add(Entity::POS_X))?;
                                    let spread = call_rng(ctx, 0x2e);

                                    ctx.set_i32_at(debris.wrapping_add(Debris::POS_X), x.wrapping_sub(spread.wrapping_mul(10)).wrapping_add(-0x1b5))?;

                                    let y = ctx.i32_at(entity.wrapping_add(Entity::POS_Y))?;
                                    let rise = call_rng(ctx, 0x1f);

                                    ctx.set_i32_at(debris.wrapping_add(Debris::POS_Y), y.wrapping_add(rise.wrapping_mul(10)).wrapping_add(-0x52d))?;
                                    ctx.set_i32_at(debris.wrapping_add(Debris::VARIANT), ctx.i32_at(entity.wrapping_add(Entity::HIT_SPARK_TYPE))?)?;
                                } else {
                                    if get_crit_fx(ctx, faction, 0)? {
                                        let fx = AppContext::CRIT_FX.wrapping_add(crit_index * AppContext::CRIT_FX_STRIDE);
                                        let x = ctx.i32_at(base.wrapping_add(Entity::POS_X))?;
                                        let spread = call_rng(ctx, 0x2e);

                                        ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_X), x.wrapping_add(spread.wrapping_mul(10)).wrapping_add(-0x3a9))?;

                                        let y = ctx.i32_at(base.wrapping_add(Entity::POS_Y))?;
                                        let rise = call_rng(ctx, 0x19);

                                        ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_Y), y.wrapping_sub(rise.wrapping_mul(10)).wrapping_add(-0x497))?;
                                    }

                                    let x = ctx.i32_at(base.wrapping_add(Entity::POS_X))?;
                                    let spread = call_rng(ctx, 0x2e);

                                    ctx.set_i32_at(debris.wrapping_add(Debris::POS_X), x.wrapping_add(spread.wrapping_mul(10)).wrapping_add(-0x3a9))?;

                                    let y = ctx.i32_at(base.wrapping_add(Entity::POS_Y))?;
                                    let rise = call_rng(ctx, 0x19);

                                    ctx.set_i32_at(debris.wrapping_add(Debris::POS_Y), y.wrapping_sub(rise.wrapping_mul(10)).wrapping_add(-0x497))?;

                                    let variant = ctx.i32_at(base.wrapping_add(Entity::HIT_SPARK_TYPE))? == 1;

                                    ctx.set_i32_at(debris.wrapping_add(Debris::VARIANT), variant as i32)?;
                                ...
                                if first && get_drain_pct(ctx, 0, slot)? > 0 {
                                    ...
                                    if get_deck_cooldown(ctx, wallet, button)? > 0 {
                                        ...
                                        if let Some(gauge) = red_gauge.get_mut(button as i64 as usize) {
                                            *gauge = gauge.wrapping_add(drained);
                                        }

                                        let (x, y) = if slot != 0 {
                                            let x = ctx.i32_at(AppContext::entity_field(0, slot, Entity::POS_X))?;
                                            let spread = call_rng(ctx, 0x2e);
                                            let y = ctx.i32_at(AppContext::entity_field(0, slot, Entity::POS_Y))?;
                                            let rise = call_rng(ctx, 0x1f);
                                        ...
                                        effect_sprite_init(&mut sprite, x, y);
                                        ctx.drain_fx.push(sprite);
                                    }
                                }

                                if !(slot != 0 || first || ctx.u8_at(AppContext::BASE_KILL_BLOCKED)? == 0) && get_hp(ctx, 1, 0)? <= 0 {
                                    set_hp(ctx, 1, 0, 1)?;
                                }

                                let survive = ctx.i32_at(entity.wrapping_add(Entity::SURVIVE_CHANCE))?;

                                if survive > 0 {
                                    let roll = call_rng(ctx, 0x64);

                                    if ctx.i32_at(entity.wrapping_add(Entity::SURVIVE_CHANCE))? >= roll
                                        && ctx.i32_at(entity.wrapping_add(Entity::HP))? <= 0
                                        && ctx.i32_at(entity.wrapping_add(Entity::SURVIVE_USED))? == 0
                                    {
                                        ctx.set_i32_at(entity.wrapping_add(Entity::HP), 1)?;
                                        ctx.set_i32_at(entity.wrapping_add(Entity::SURVIVE_USED), 1)?;
                                ...
                                'knock: {
                                    if ctx.i32_at(entity.wrapping_add(Entity::HP))? <= 0 {
                                        ...
                                        if first {
                                            ctx.set_i32_at(AppContext::KILLS_SINCE_SPAWN_TICK, ctx.i32_at(AppContext::KILLS_SINCE_SPAWN_TICK)?.wrapping_add(1))?;
                                        } else {
                                    ...
                                    if !first && has_castle_enemy(ctx)? && get_entity_base_idx(ctx)? as u32 as i32 == slot {
                                        break 'knock;
                                    }

                                    let max = get_max_hp(ctx, faction, slot)?;
                                    let knockbacks = get_knockbacks(ctx, faction, slot)?;
                                    let thresholds = ctx.i32_at(entity.wrapping_add(Entity::KNOCKBACKS))?;
                                    let mut crossed_now = 0i32;
                                    let mut crossed_before = 0i32;

                                    if thresholds > 0 {
                                        let step = max as f32 / knockbacks as f32;
                                        let hp = ctx.i32_at(entity.wrapping_add(Entity::HP))? as f32;
                                    ...
                                    if get_entity_state(ctx, faction, slot)? == 4 || get_entity_state(ctx, faction, slot)? == 0x15 {
                                        break 'knock;
                                    }

                                    let knocked = (crossed_now != crossed_before && crossed_now != ctx.i32_at(entity.wrapping_add(Entity::KNOCKBACKS))?)
                                        || ctx.i32_at(entity.wrapping_add(Entity::SURVIVE_USED))? == 1;

                                    if knocked {
                                        set_entity_state(ctx, faction, slot, 3)?;
                                        set_entity_frame(ctx, faction, slot, 0)?;

                                        if get_zkill_hit(ctx, faction, slot)? && get_hp(ctx, faction, slot)? == 0 {
                                            set_no_revive(ctx, faction, slot, 1)?;

                                            let mut free = None;

                                            for record in 0..0x1eusize {
                                                if ctx.u8_at(AppContext::ZKILL_FX.wrapping_add(record * AppContext::ZKILL_FX_STRIDE))? == 0 {
                                                    free = Some(record);
                                            ...
                                            if let Some(record) = free {
                                                let fx = AppContext::ZKILL_FX.wrapping_add(record * AppContext::ZKILL_FX_STRIDE);

                                                clear_zkill_fx_slot(ctx, fx)?;
                                                ctx.set_block_at::<1>(fx, [1])?;

                                                let x = ctx.i32_at(entity.wrapping_add(Entity::POS_X))?;
                                                let spread = call_rng(ctx, 0x2e);

                                                ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_X), x.wrapping_sub(spread.wrapping_mul(10)).wrapping_add(0xfa))?;

                                                let y = ctx.i32_at(entity.wrapping_add(Entity::POS_Y))?;
                                                let rise = call_rng(ctx, 0x1f);

                                                ctx.set_i32_at(fx.wrapping_add(FxSlot::POS_Y), y.wrapping_add(rise.wrapping_mul(10)).wrapping_add(-0x96))?;
                                                play_sound_in_battle(ctx, 0x3b)?;
                                            }
                                        }

                                        if ctx.i32_at(entity.wrapping_add(Entity::DOUBLE_BOUNTY_STATE))? == 1 {
                                            ctx.set_i32_at(entity.wrapping_add(Entity::DOUBLE_BOUNTY_STATE), 2)?;
                                        }

                                        if ctx.i32_at(entity.wrapping_add(Entity::SURVIVE_USED))? == 1 {
                                            ctx.set_i32_at(entity.wrapping_add(Entity::SURVIVE_USED), 2)?;
                                        }
                                    } else if get_warp_timer(ctx, faction, slot)? > 0 && get_hp(ctx, faction, slot)? > 0 {
                                ...
                                let music_row = AppContext::MAP_STAGE_ROWS.wrapping_add((ctx.i32_at(AppContext::STAGE_MUSIC_ROW)? as i64 as usize).wrapping_mul(AppContext::MAP_STAGE_ROW_STRIDE));
                                let key = ctx.block_at::<4>(music_row.wrapping_add(0xb8))?;
                                let cell = ctx.block_at::<4>(music_row.wrapping_add(0xc))?;
                                let switch_percent = i32::from_le_bytes([cell[0] ^ key[0], cell[1] ^ key[1], cell[2] ^ key[2], cell[3] ^ key[3]]);
                                ...
                                let key = ctx.block_at::<4>(music_row.wrapping_add(0xb8))?;
                                let cell = ctx.block_at::<4>(music_row.wrapping_add(0xc))?;
                                let percent = i32::from_le_bytes([cell[0] ^ key[0], cell[1] ^ key[1], cell[2] ^ key[2], cell[3] ^ key[3]]);
                                ...
                                ctx.set_block_at::<4>(AppContext::BGM_SWITCH_NEXT, [cell[0] ^ key[0], cell[1] ^ key[1], cell[2] ^ key[2], cell[3] ^ key[3]])?;
                            ...
                            for button in 0..10i32 {
                                ...
                                let flash = wallet.wrapping_add(AppContext::WALLET_RED_GAUGE_FRAMES).wrapping_add(button as usize * 4);

                                if ctx.i32_at(flash)? == 0 || get_deck_cooldown_max(ctx, wallet, button)? > get_deck_cooldown(ctx, wallet, button)? {
                                ...
                                let refund = max_i32(operation::div_neg_100(drained.wrapping_mul(span)).wrapping_add(span), 0);

                                set_deck_cooldown(ctx, wallet, button, recharge.wrapping_sub(refund), 0)?;

                                let frames = get_setting(&ctx.settings, b"battle_red_gauge_frame", 0xf)?;
                        ...
                        if get_battle_status(ctx)? == 0 {
                            ...
                            for faction in 0..2i32 {
                                ...
                                for button in 0..10i32 {
                                    ...
                                    if get_deck_cooldown(ctx, wallet, button)? > 0 {
                                        if get_unit_recharge(ctx, faction, button)? < get_deck_cooldown(ctx, wallet, button)? {
                                            let recharge = get_unit_recharge(ctx, faction, button)?;
                                    ...
                                    if check_orb {
                                        let deploys = ctx.i32_at(wallet.wrapping_add(AppContext::WALLET_DEPLOY_COUNTS).wrapping_add(slot))?;
                                        let seen = wallet.wrapping_add(AppContext::WALLET_ORB_DEPLOYS_SEEN).wrapping_add(slot);

                                        if ctx.i32_at(seen)? <= deploys {
                                            ctx.set_i32_at(seen, deploys.wrapping_add(1))?;

                                            if orb_deploy_condition(ctx, wallet, 0, button)? {
                                                ctx.set_i32_at(wallet.wrapping_add(AppContext::WALLET_SLOT_FLASH).wrapping_add(slot), 0)?;
                                            }
                                        }
                                    }

                                    if ctx.i32_at(wallet.wrapping_add(AppContext::WALLET_CONJURE_READY).wrapping_add(slot))? == 1 {
                                        let lockout = wallet.wrapping_add(AppContext::WALLET_CONJURE_LOCKOUT).wrapping_add(slot);
                                    ...
                                    let gauge = wallet.wrapping_add(AppContext::WALLET_RED_GAUGE_FRAMES).wrapping_add(slot);
                        ...
                        let worker = ctx.i32_at(AppContext::WORKER_UPGRADE_FX)?;

                        if worker > 0 {
                            ctx.set_i32_at(AppContext::WORKER_UPGRADE_FX, worker.wrapping_sub(1))?;
                        }

                        for spark in 0..50usize {
                            let record = AppContext::PENDING_STRIKE_SPARKS.wrapping_add(spark * AppContext::PENDING_STRIKE_SPARKS_STRIDE);
                ...
                ctx.set_i32_at(AppContext::DRAW_FRAMES, ctx.i32_at(AppContext::DRAW_FRAMES)?.wrapping_add(1))?;
                ...
                ctx.set_f32_at(AppContext::CAT_GOD_GLOW, 0.5 + ctx.f32_at(AppContext::CAT_GOD_GLOW)?)?;
                break 'frame;
            }
        }
    ...
    ctx.set_i32_at(AppContext::BATTLE_TICKS, ctx.i32_at(AppContext::BATTLE_TICKS)?.wrapping_add(1))?;
    ...
    ctx.set_i32_at(AppContext::UI_TAP_LOCKOUT, if lockout < 2 { 0 } else { lockout.wrapping_sub(1) })?;
