...
use super::{
    AppContext, get_se_volume_setting, new_button_node, option_step_volume, option_volume_step,
    play_sound, set_se_volume_setting, sound_manager, ui_node_set_cut,
};

pub fn option_window_se_volume(
    ctx: &mut AppContext,
    button: i32,
    event: i32,
    cuts: [i32; 4],
    ...
    let sound = match event {
        ...
        3 => {
            ...
            set_se_volume_setting(sound_manager(ctx)?, volume);
