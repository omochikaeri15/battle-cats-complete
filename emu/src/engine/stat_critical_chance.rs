...
use super::{get_cat_combo_bonus, get_talent_value, read_flag, AppContext, CatStats, EnemyStats};
...
pub fn stat_critical_chance(ctx: &mut AppContext, faction: i32, unit_id: i32, form: i32) -> Result<i32, Fault> {
    ...
    let base = ctx.i32_at(AppContext::cat_stat(unit_id, form, CatStats::CRITICAL_CHANCE))?;
