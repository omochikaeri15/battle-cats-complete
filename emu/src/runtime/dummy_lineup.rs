...
const LINEUP: [Member; 8] = [
    Member { unit: 92, form: 2, level: 50, plus: 0, talents: Talents::None },
    Member { unit: 148, form: 2, level: 50, plus: 0, talents: Talents::One(HITPOINTS_TALENT, 10) },
    Member { unit: 834, form: 1, level: 30, plus: 0, talents: Talents::None },
    Member { unit: 397, form: 3, level: 60, plus: 0, talents: Talents::None },
    Member { unit: 273, form: 1, level: 40, plus: 0, talents: Talents::None },
    Member { unit: 32, form: 2, level: 50, plus: 30, talents: Talents::Normal },
    Member { unit: 439, form: 2, level: 60, plus: 0, talents: Talents::Every },
    Member { unit: 830, form: 1, level: 40, plus: 0, talents: Talents::None },
];
