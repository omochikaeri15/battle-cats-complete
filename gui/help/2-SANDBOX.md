...
To remove a unit from a line-up, right click on them, and the context menu will give you an option to do so.
...
- **Tech:** The tech upgrades you find alongside the Normal cats, as well as a meta `Level Cap` for the Aku Altar.
